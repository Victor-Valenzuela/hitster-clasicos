...
async function main() {
    let okAudio = 0,
        ...
        skip = 0;
    const resultado = [];
    console.log('Descargando audio + portadas de ' + canciones.length + ' canciones...\n');
    ...
    // Actualizar clasicos.json con rutas locales
    ...
    writeFileSync('src/data/clasicos.json', JSON.stringify(actualizadas, null, 2));

    console.log('\nListo!');
    console.log('Audio: ' + okAudio + ' descargados, ' + skip + ' ya existían, ' + fail + ' no encontrados');
